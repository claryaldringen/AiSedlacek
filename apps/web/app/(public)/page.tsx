          ...
          <div className="mt-12 grid gap-8 sm:grid-cols-3">
            <div className="text-center">
              ...
              <p className="mt-2 text-sm leading-relaxed text-slate-500">
                Nahrajte sken nebo fotografii historického textu. Podporujeme JPEG, PNG, TIFF i
                WebP. Můžete i vložit URL z digitálních knihoven.
              </p>
            </div>
            <div className="text-center">
              <div className="mx-auto flex h-12 w-12 items-center justify-center rounded-full bg-blue-100 text-blue-600">
              ...
              <p className="mt-2 text-sm leading-relaxed text-slate-500">
                Claude Vision přečte text z obrázku, přeloží ho do moderního jazyka a doplní
                historický kontext s glosářem.
              </p>
            </div>
            <div className="text-center">
              <div className="mx-auto flex h-12 w-12 items-center justify-center rounded-full bg-blue-100 text-blue-600">
              ...
              <h3 className="mt-4 text-base font-semibold text-slate-800">
                3. Diskutujte a opravujte
              </h3>
              <p className="mt-2 text-sm leading-relaxed text-slate-500">
                V integrovaném chatu se můžete modelu zeptat na cokoliv o dokumentu a nechat ho
                opravit transkripci nebo překlad.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="border-t border-slate-200 bg-slate-800 py-16">
        <div className="mx-auto max-w-5xl px-6 text-center">
          ...
          <p className="mx-auto mt-4 max-w-xl text-sm leading-relaxed text-slate-400">
            ...
            který zasvětil život studiu historických pramenů. Naším cílem je zpřístupnit středověké
            texty moderním čtenářům.
          </p>
          <Link
            href="/login"
